...
% --- PROFIL ---
\section*{Profil}
\noindent Actuellement en alternance chez Afludia (Bac+3, fin de contrat en janvier 2027), j'aimerais poursuivre mon parcours vers la cybersécurité (Bac+5) et je recherche actuellement mon école pour la rentrée 2027. Ma priorité est de trouver mon entreprise d'accueil en alternance. Ouvert à découvrir les différents domaines du secteur (SOC, sécurité opérationnelle, gouvernance), mon socle systèmes et réseaux (Active Directory, virtualisation, supervision) constitue une base directement mobilisable pour la défense d'infrastructures.
