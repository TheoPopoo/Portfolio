...
\begin{itemize}[leftmargin=0.5cm, noitemsep, topsep=0pt, partopsep=0pt]
    \item Déploiement et durcissement de postes Windows 11 (SSD, PPKG, réinstallations), mon plus gros volume d'activité.
    \item Administration réseau (VLAN, DHCP/DNS, Wifi, câblage, switchs, routeurs) et virtualisation Hyper-V.
    \item Sécurité : Patch Tuesday mensuels, suivi des CVE, gestion des accès et hardening Windows 11.
