...
\begin{itemize}[leftmargin=0.5cm, noitemsep, topsep=0pt, partopsep=0pt]
    \item \textbf{Cybersécurité \& Supervision :} Pfsense, Zabbix, Grafana, gestion des identités Azure AD / Entra ID, segmentation réseau (VLAN).
...
\noindent {\fontsize{12}{14}\bfseries Administrateur Systèmes \& Réseaux / Développeur} \hfill \textbf{2024 — Janvier 2027} \\
\textit{Afludia} \hfill \textit{France} \\
\textit{CDI : octobre 2024 -- janvier 2026} \\
\textit{Alternance : janvier 2026 -- janvier 2027}
\begin{itemize}[leftmargin=0.5cm, noitemsep, topsep=0pt, partopsep=0pt]
...
\noindent {\fontsize{12}{14}\bfseries Administrateur Système (CDD)} \hfill \textbf{Juin 2024 — Septembre 2024} \\
...
\noindent {\fontsize{12}{14}\bfseries Technicien Réseau \& Helpdesk (CDD)} \hfill \textbf{Juillet 2023} \\
\textit{Röchling Group} \hfill \textit{France}
\begin{itemize}[leftmargin=0.5cm, noitemsep, topsep=0pt, partopsep=0pt]
    \item Gestion efficace des tickets de dépannage.
    \item Support technique sur une solution téléphonique innovante (3CX).
    \item Mise en place de nouveaux postes de travail via SCCM.
    \item Tâches de câblage pour les équipements.
\end{itemize}

\vspace{0.1cm}

\noindent {\fontsize{12}{14}\bfseries Administrateur Réseau et Systèmes (Alternance)} \hfill \textbf{Octobre 2022 — Février 2023} \\
\textit{AFTRAL} \hfill \textit{France}
\begin{itemize}[leftmargin=0.5cm, noitemsep, topsep=0pt, partopsep=0pt]
    \item Mise en place d'un outil de gestion du parc informatique (GLPI).
    \item Déploiement de PC pour agents via serveur SCCM.
    \item Configuration et installation du matériel.
...
\textit{IPSSI} \hfill \textit{Alternance 2 ans}

\vspace{0.1cm}

\noindent \textbf{Bachelor Administrateur Systèmes, Réseaux \& Cybersécurité} \hfill \textbf{2026 — 2027} \\
\textit{LiveCampus} \hfill \textit{Alternance chez Afludia depuis janvier 2026}
...
\noindent Informatique, Cinéma, Foot, Jeux de société
